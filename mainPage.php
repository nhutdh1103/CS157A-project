    ...
    <div class="categories">
        ...
        <div class="small-container">
            ...
            <div class = "row">
                <div class="col-4">
                    <!-- Fruits -->
                    <a href= "category-Fruits.php"><img src="images/avocado.jpg"></a>
                    <br>
                    <h3> Fruits</h3>
                </div>
            ...
            <div id="myCarousel" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img class="img-fluid" src="images/avatar.jpg" alt="First Slide">
                        <div class="carousel-caption">
                            <h3>Do Tran</h3>
                          </div>
                    </div>
                    <div class="carousel-item">
                        <img  src="images/avatar1.jpg" alt="Second Slide">
                        <div class="carousel-caption">
                            <h3>Quyen Nguyen</h3>
                          </div>
                    </div>
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption">
                            ...
                            <h3 style="margin-top: 14%;">Mai Tran</h3>
                          </div>
                    </div>
                    <div class="carousel-item">
